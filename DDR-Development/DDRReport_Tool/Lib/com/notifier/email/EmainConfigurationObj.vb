...
Namespace com.Notifier.Email
    Public Class EmailConfigurationObj
        ...
        Public Overridable Sub LoadDefaultConfiguration()
            Try
                _UserCredential = Configuration.ConfigurationSettings.AppSettings("EmailUserCredential")
                _PassCredential = Configuration.ConfigurationSettings.AppSettings("EmailPasswordCredential")
                _SMTPServerHost = Configuration.ConfigurationSettings.AppSettings("EmailSMTPHost")
                _SMTPServerPort = Integer.Parse(Configuration.ConfigurationSettings.AppSettings("EmailSMTPPort"))
