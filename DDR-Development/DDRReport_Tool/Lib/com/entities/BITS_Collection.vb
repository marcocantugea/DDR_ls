Namespace com.entities
    Public Class BITS_Collection
        Implements IEnumerable, IEnumerator, ICollection

        Private position As Integer = -1
        Private _Items As New List(Of BITS)

        Public ReadOnly Property Items() As List(Of BITS)
            Get
                Return _Items
            End Get
        End Property
        ...
        Public Sub Add(ByVal Bits As BITS)
            If Not IsNothing(Bits) Then
                _Items.Add(Bits)
            End If
        End Sub
