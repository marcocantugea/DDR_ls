Namespace com.entities
    Public Class MarineInfo_Collection
        Implements IEnumerable, IEnumerator, ICollection

        Private position As Integer = -1
        Private _Items As New List(Of MarineInfo)

        Public ReadOnly Property Items() As List(Of MarineInfo)
            Get
                Return _Items
            End Get
        End Property
        ...
        Public Sub Add(ByVal Item As MarineInfo)
