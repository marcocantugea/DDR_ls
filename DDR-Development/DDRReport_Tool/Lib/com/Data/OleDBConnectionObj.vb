...
Namespace com.data
    Public Class OleDBConnectionObj
        ...
        Public Sub New()
            ...
            For Each s As String In Configuration.ConfigurationSettings.AppSettings
                If s.Contains("DB-") Then
                    cont = True
                    Dim con As New com.data.ConnectionsProperty
                    con.Name = s
                    con.ConectionString = Configuration.ConfigurationSettings.AppSettings(s)
        ...
        Protected Sub CreateConnection(ByVal ConnectionName As String, ByVal DatabaseToOpen As String)
            ...
            con.ConectionString = Configuration.ConfigurationSettings.AppSettings(DatabaseToOpen)
            connections.Add(con, con.Name)
        End Sub
