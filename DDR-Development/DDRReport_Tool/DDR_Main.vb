...
Public Class DDR_Main
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        '20 - Oct - 2018
        'Desabilitar la opcion de crear un DDR en blanco
        'Dim i As Integer
    ...
    Public Sub LoadDDRControlGrid()
        ...
        For Each o_ddr As com.entities.DDRControl In ddrs_collected.Items
            row = New String() {o_ddr.DDRID.ToString, o_ddr.ReportDate, o_ddr.ReportNo.ToString, o_ddr.Well, o_ddr.Description, o_ddr.Locked.ToString, o_ddr.Active.ToString}
    ...
    Public Sub LoadWells()
        Dim adDDR As New com.ADO.ADOMySQLDDR
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If frm_DDR_Form.DDRReport.Locked Then
