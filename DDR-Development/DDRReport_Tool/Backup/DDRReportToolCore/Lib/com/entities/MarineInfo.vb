Namespace com.entities
    Public Class MarineInfo
        ...
        Private _Comments_spanish As String
        Private _RigWash As String


        Public Property RigWash() As String
            Get
                Return _RigWash
            End Get
        ...
        Public Property Comments_spanish() As String
            Get
                Return _Comments_spanish
            End Get
            Set(ByVal value As String)
                _Comments_spanish = value
            End Set
        End Property
        ...
        Public Property RecivedMade_PotWater() As String
            Get
                Return _RecivedMade_PotWater
            End Get
            Set(ByVal value As String)
                _RecivedMade_PotWater = value
            End Set
        End Property

        Public Property Used_CmtBlended() As String
            Get
                Return _Used_CmtBlended
            End Get
            Set(ByVal value As String)
                _Used_CmtBlended = value
            End Set
        End Property
