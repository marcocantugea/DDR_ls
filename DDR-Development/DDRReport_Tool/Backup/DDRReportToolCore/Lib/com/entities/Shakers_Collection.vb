Namespace com.entities
    Public Class Shakers_Collection
        Implements IEnumerable, IEnumerator, ICollection

        Private position As Integer = -1
        Private _Items As New List(Of Shakers)

        Public ReadOnly Property Items() As List(Of Shakers)
            Get
                Return _Items
            End Get
        End Property
        ...
        Public Sub Add(ByVal Item As Shakers)
