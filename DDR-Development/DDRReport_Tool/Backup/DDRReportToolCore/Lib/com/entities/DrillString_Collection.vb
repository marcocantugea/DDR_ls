...
Namespace com.entities
    Public Class DrillString_Collection
        Implements IEnumerable, IEnumerator, ICollection

        Private position As Integer = -1
        Private _Items As New List(Of DrillString)

        Public ReadOnly Property Items() As List(Of DrillString)
            Get
                Return _Items
            End Get
        End Property
        ...
        Public Sub Add(ByVal Item As DrillString)
