...
Namespace com.data
    Public Class ODBCConnectionObj
        ...
        Protected connection As com.data.ODBCConnectionProperties
        ...
        Public Sub New()
            ...
            For Each s As String In System.Configuration.ConfigurationSettings.AppSettings
                If s.Contains("DB-") Then
                    cont = True
                    Dim con As New com.data.ODBCConnectionProperties
                    con.Name = s
        ...
        Public Sub New(ByVal ConnectionProperty As com.data.ODBCConnectionProperties)
