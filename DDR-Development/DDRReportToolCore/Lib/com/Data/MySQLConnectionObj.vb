...
Namespace com.data
    Public Class MySQLConnectionObj
        ...
        Protected connection As com.data.MySQLConnectionProperties
        ...
        Public Sub New()
            ...
            For Each s As String In System.Configuration.ConfigurationSettings.AppSettings
                If s.Contains("DB-") Then
                    cont = True
                    Dim con As New com.data.MySQLConnectionProperties
                    con.Name = s
        ...
        Public Sub New(ByVal ConnectionProperty As com.data.MySQLConnectionProperties)
