...
'20 - Oct- 2018
'Clase Agregada Para implementar MYSQL server

Namespace com.ADO
    Public Class ADOMySQLDDR
        Inherits com.data.MySQLConnectionObj
...
#Region "Save Info Functions"
        ...
        Public Sub SaveDDRControl(ByVal ddrcontrol As DDRControl)
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand(qbuilder.Query, connection.Connection)
...
#End Region
        ...
        Private Sub DeleteDDR_Report(ByVal DDR_ID As Integer)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from DDR_Report where DDRID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_BITS where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_Detail_Hrs where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_DrillString where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_DrillString_Surveys where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_Marine where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_Mud where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_POB where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_PUMPS where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_Shakers where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from RiserProfile where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_SOC where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
                connection.Command = New MySqlCommand("Delete from DDR_LogisticTransitLog where DDR_Report_ID=" & DDR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
...
#Region "Geters Info"
        ...
        Public Function GetLastIDDDR(ByVal Well As String) As Integer
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select max(DDRID) from DDR_CONTROL where Well='" & Well & "'", connection.Connection)
        ...
        Public Function GetLastID(ByVal table As String, ByVal field As String) As Integer
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select max(" & field & ") from " & table, connection.Connection)
                result = connection.Command.ExecuteScalar()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Function GetLastDDRUpdate(ByVal ddrid As String) As Date
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select lastupdate from DDR_Control where DDRID=" & ddrid, connection.Connection)
                result = connection.Command.ExecuteScalar()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub GetDDRControlHeader(ByVal ddr As DDRControl_Collection)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_Control", connection.Connection)
        ...
        Public Sub GetWells(ByVal wells As Collection)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select distinct Well from DDR_Control", connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetDDRControlHeader(ByVal DDRID As Integer) As DDRControl
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_Control where DDRID=" & DDRID.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetDDRReport(ByVal ddrid As Integer) As DDRReport
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_Report where DDRID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetDDRHrs(ByVal ddrid As Integer) As DDRHrs_Collection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_Detail_Hrs where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetDDRBits(ByVal ddrid As Integer) As BITS_Collection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_BITS where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetDrillString(ByVal ddrid As Integer) As DrillString_Collection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_DrillString where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetDrillStringSurvey(ByVal ddrid As Integer) As DrillString_Survey_Collection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_DrillString_Surveys where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetMarineInfo(ByVal ddrid As Integer) As MarineInfo
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_Marine where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetPOB(ByVal ddrid As Integer) As POB
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_POB where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetPumps(ByVal ddrid As Integer) As Pumps_Collection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_PUMPS where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetShakers(ByVal ddrid As Integer) As Shakers_Collection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_Shakers where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetMud(ByVal ddrid As Integer) As Mud_Collection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_Mud where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetActivities(ByVal ddrid As Integer) As Activities_Collection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from Activities_Details where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetRiserProfile(ByVal ddrid As Integer) As RiserProfileCollection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from RiserProfile where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetSOC(ByVal ddrid As Integer) As SOC
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_SOC where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
                If dts.Tables.Count > 0 Then
        ...
        Public Function GetLogisticTransitLog(ByVal ddrid As Integer) As LogisticTransitLogCollection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_LogisticTransitLog where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetUrgentsMR(ByVal ddrid As Integer) As UrgentsMRsCollection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from Activities_UrgentMRs where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetWO(ByVal ddrid As Integer) As WorkOrderCollection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from Activities_WorkOrders where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function GetPUMR(ByVal ddrid As Integer) As PUMR_Collection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from DDR_PUMR where DDR_Report_ID=" & ddrid.ToString, connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
...
#Region "Modifiers"
        ...
        Public Sub UpdateF1SupervisorName(DDRReportID As Integer, Supervisorname As String)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Update DDR_Report set  F1SupervisorName='" & Supervisorname & "' where DDR_Report_ID=" & DDRReportID.ToString, connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub UpdateF1SuperintendentName(DDRReportID As Integer, name As String)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Update DDR_Report set  F1RigSuperintName='" & name & "' where DDR_Report_ID=" & DDRReportID.ToString, connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
...
#End Region
        ...
        Public Sub LockReprot(ByVal DDRID As Integer)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("update ddr_Control set Locked=-1 where DDRID=" & DDRID.ToString, connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub UnlockReprot(ByVal DDRID As Integer)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("update ddr_Control set Locked=0 where DDRID=" & DDRID.ToString, connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub GetUserGroup(ByVal suser As com.entities.SessionUser)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select UserGroup from users_group where username='" & suser.User & "'", connection.Connection)
                If Not IsDBNull(connection.Command.ExecuteScalar()) Then
        ...
        Public Sub GetUserDeparmentID(ByVal suser As com.entities.SessionUser)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select DepartmentID from users_group where username='" & suser.User & "'", connection.Connection)
        ...
        Public Sub GetUseremail(ByVal suser As com.entities.SessionUser)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select email from users_group where username='" & suser.User & "'", connection.Connection)
        ...
        Public Function GetDeparmentID(ByVal DeparmentName As String) As Integer
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select Deparment_ID from Activities_Deparments where description='" & DeparmentName & "'", connection.Connection)
        ...
        Public Sub GetUserDeparmentName(ByVal suser As com.entities.SessionUser)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select Description from Activities_Deparments where Deparment_ID=" & suser.DepartmentId, connection.Connection)
        ...
        Public Sub PrepareNotification(ByVal emailcollection As com.Notifier.Email.EmailObjCollection, ByVal templatemessage As com.Notifier.Email.EmailObj, ByVal sender As String)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select email from Users_Group where notify=-1", connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Sub UpdateDateAndReportNo(ByVal reportno As Integer, ByVal reportdate As Date, ByVal ddrid As Integer)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("update DDR_Control set ReportDate='" & reportdate.ToString("yyyy-MM-dd") & "',ReportNo=" & reportno & " where DDRID=" & ddrid, connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
...
#Region "Activities"
        ...
        Public Sub DeleteActivities(ByVal DDRID As Integer)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from Activities_Details where DDR_Report_ID=" & DDRID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub DeleteActivities(ByVal activity As Activities)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from Activities_Details where Act_Detail_ID=" & activity.Act_Detail_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
...
#Region "MR Urgents"
        ...
        Public Sub DeleteUrgentMR(ByVal MR As UrgentMRs)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from Activities_UrgentMRs where MRUrgentID=" & MR.MRUrgentID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
...
#Region "PEMEX MR Urgents"
        ...
        Public Sub DeletePUMR(ByVal MR As PUMR)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from DDR_PUMR where PRUM_ID=" & MR.PRUM_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
...
#Region "Work Orders"
        ...
        Public Sub DeleteWorkOrder(ByVal WO As WorkOrder)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from Activities_WorkOrders where WorkOrderID=" & WO.WorkOrderID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
...
#End Region
        ...
        Public Sub DeleteDDHrs(ByVal ddrhrs As DDRHrs)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from DDR_Detail_Hrs where Detail_Hr_ID=" & ddrhrs.Detail_HR_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub DeleteBITS(ByVal Bits As BITS)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from DDR_BITS where BITS_ID=" & Bits.BITS_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub DeleteShaker(ByVal shaker As Shakers)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from DDR_Shakers where Shakers_ID=" & shaker.Shakers_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub DeleteMud(ByVal mud As Mud)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from DDR_Mud where MUD_ID=" & mud.MUD_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub DeleteStringSurvey(ByVal StringSurvey As DrillString_Survey)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from ddr_drillstring_surveys where Survey_ID=" & StringSurvey.Survey_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub DeleteRiserProfile(riserprodile As RiserProfile)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from riserprofile where IDRiserProfile=" & riserprodile.IDRiserProfile.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Function GetTabSelected(ByVal obj_tosearch As SystemOpenedTab) As SystemOpenedTab
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from  System_openedTabs where Tab_sel='" & obj_tosearch.Tab_sel & "' and Active=1", connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
                If dts.Tables.Count > 0 Then
        ...
        Public Function GetTabSelectedUser(ByVal obj_tosearch As SystemOpenedTab) As SystemOpenedTab
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from  System_openedTabs where User_sess='" & obj_tosearch.User_sess & "' and Active=1", connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
                If dts.Tables.Count > 0 Then
        ...
        Public Function GetOpenedTabs() As System_OpenedTab_Collection
            ...
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("select * from System_openedTabs where Active=1", connection.Connection)
                connection.Adap = New MySqlDataAdapter(connection.Command)
                Dim dts As New DataSet
                connection.Adap.Fill(dts)
        ...
        Public Function HasOpenedTabs(ByVal opentab As entities.SystemOpenedTab) As Boolean
            ...
            If (opentab.User_sess <> "" And opentab.Tab_sel <> "") Or (Not IsNothing(opentab.User_sess) And Not IsNothing(opentab.Tab_sel)) Then
                Try
                    OpenDB("DB-DDR")
                    connection.Command = New MySqlCommand("select count(1) from System_openedTabs where User='" & opentab.User_sess & "' and Tab='" & opentab.Tab_sel & "' and Active=1", connection.Connection)
                    result = connection.Command.ExecuteScalar()
                Catch ex As Exception
                    Throw
                Finally
        ...
        Public Sub DeleteLogOpenTab(ByVal opentab As SystemOpenedTab)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from System_openedTabs where OpenedTab_ID=" & opentab.OpenedTab_ID.ToString & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub DeleteLogOpenTabs(ByVal opentab As SystemOpenedTab)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from System_openedTabs where User_sess='" & opentab.User_sess & "'", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
        ...
        Public Sub DeleteLogisticTransitLog(ByVal item As LogisticTransitLog)
            Try
                OpenDB("DB-DDR")
                connection.Command = New MySqlCommand("Delete from DDR_LogisticTransitLog where LTID=" & item.LTID & "", connection.Connection)
                connection.Command.ExecuteNonQuery()
            Catch ex As Exception
                Throw
            Finally
